...
from algorithm_v1.common.device import empty_cache, synchronize
...
class GPTQ:
    ...
    def fasterquant(
        ...
        H = self.H
        del self.H
        offload_hessian_to_cpu = H.device.type == "npu" or (
            H.device.type == "cuda" and self.columns >= CPU_HESSIAN_OFFLOAD_COLUMNS
        )
