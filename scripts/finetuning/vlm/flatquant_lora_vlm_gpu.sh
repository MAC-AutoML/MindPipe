...
# Standard VLM compression LoRA entrypoint.
# Examples: MiniCPM-V, Qwen2.5-VL, Qwen3-VL. Use qwen3_5/ for Qwen3.5/Qwen3.6 dense VLMs.
...
COMPRESSION_LORA_TARGET_MODULES="${COMPRESSION_LORA_TARGET_MODULES:-q_proj k_proj v_proj o_proj gate_proj up_proj down_proj}"
