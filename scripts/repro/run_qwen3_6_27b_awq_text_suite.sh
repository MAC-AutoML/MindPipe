...
OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO_ROOT/new_results/quantization_suite/awq_qwen3_6_27b_text_suite}"
...
print_banner() {
  ...
  echo "[INFO] plan: full_precision(seq=${SEQ_LENGTHS[*]}) + AWQ w{${WEIGHT_BITS_LIST[*]}}a16 g${WEIGHT_GROUP_SIZE} @ seq=${SEQ_LENGTHS[*]}"
}
