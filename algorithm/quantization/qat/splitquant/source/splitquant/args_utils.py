...
def parser_gen():
    ...
    # SplitQuant calibration arguments
    parser.add_argument('--epochs', type=int, default=15, help='Number of training epochs.')
    parser.add_argument('--cali_dataset', type=str, default='wikitext2',
                        help='Calibration dataset for SplitQuant and GPTQ.', choices=supported_datasets)
    ...
    parser.add_argument('--save_matrix', action="store_true", default=False, 
                        help='Save the matrix-style parameters of SplitQuant.')
    ...
    parser.add_argument('--matrix_path', type=str, default=None,
                        help='Path to the pre-trained matrix-style parameters of SplitQuant.')
