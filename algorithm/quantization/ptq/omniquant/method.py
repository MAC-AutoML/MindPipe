...
class OmniQuantMethod(BaseQuantizationMethod):
    ...
    def _validate_args(self, model, args) -> None:
        ...
        if model_type in {"qwen3_5", "qwen3_5_moe", "qwen3_5_moe_text"} and bool(args.omniquant_let):
            raise ValueError(
                "Qwen3.5/Qwen3.5-MoE OmniQuant support in MindPipe currently follows the LWC-only path; "
